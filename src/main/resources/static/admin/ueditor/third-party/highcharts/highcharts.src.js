...
SVGElement.prototype = {
	...
	*/
	...
	add: function (parent) {
		...
		fireEvent(this, 'templates.gen.page.add');
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		 ...
		 */
		addEvent(wrapper, 'templates.gen.page.add', getSizeAfterAdd);
		...
		return extend(wrapper, {
			 ...
			 */
			destroy: function () {
				removeEvent(wrapper, 'templates.gen.page.add', getSizeAfterAdd);
...
Highcharts.VMLElement = VMLElement = {
	...
	add: function (parent) {
		...
		// fire an event for internal hooks
		fireEvent(wrapper, 'templates.gen.page.add');
			...
			if (prop === 'fill') {
				...
				// Radial (circular) gradient
					...
					if (wrapper.added) {
						...
						addEvent(wrapper, 'templates.gen.page.add', applyRadialGradient);
					}
