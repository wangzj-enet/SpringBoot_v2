...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            indentLine: operation(function(n, dir) {
                if (isLine(n)) indentLine(n, dir == null ? "smart" : dir ? "templates.gen.page.add" : "subtract");
            }),
        ...
        function indentLine(n, how) {
            if (!how) how = "templates.gen.page.add";
            if (how == "smart") {
            ...
            else if (how == "templates.gen.page.add") indentation = curSpace + options.indentUnit;
    ...
    var commands = CodeMirror.commands = {
        ...
        indentMore: function(cm) {cm.indentSelection("templates.gen.page.add");},
