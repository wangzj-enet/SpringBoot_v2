...
*/
    ...
    if (body && util.isHostMethod(body, "createControlRange")) {
        ...
        if (util.areHostProperties(testControlRange, ["item", "templates.gen.page.add"])) {
...
wysihtml5.dom.getAsDom = (function() {
  ...
  var HTML5_ELEMENTS = [
    ...
    "figure", "footer", "templates.cms.common.html.header", "hgroup", "keygen", "mark", "meter", "nav", "output", "progress",
      ...
      var that = this,
          callbackWrapper = function(event) {
            ...
            if (attributes == that.elementToChange) {
              that.fire("templates.gen.page.HOME.nav.edit", attributes);
            } else {
