...
//        fileList.add(file2);
	...
	public static void main(String[] args) throws Exception {
		...
		mailInfo.setValidate(true);
		mailInfo.setSsl(true);
		mailInfo.setUserName("383876583@qq.com");
		mailInfo.setPassword("hcsmbgpmrfjhcbcc");// 您的邮箱密码
		mailInfo.setFromAddress("383876583@qq.com");//发件人地址
		mailInfo.setToAddress("admin@championgrass.cn");//收件人地址
		mailInfo.setSubject("设置邮箱标题wwwwww");
		mailInfo.setContent("test  383876583@qq.com sssss");
		// 这个类主要来发送邮件
		SimpleEmailUtil sms = new SimpleEmailUtil();
		sms.sendTextMail(mailInfo);//发送文体格式
