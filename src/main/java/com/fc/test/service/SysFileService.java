...
public class SysFileService implements BaseService<TsysFile, TsysFileExample>{
	...
	public int insertSelective(TsysFile record,String dataId) {
		...
		TsysDatas tsysDatas = tsysDatasMapper.selectByPrimaryKey(dataId);
		record.setFileName(record.getFileName()+"["+tsysDatas.getFilePath()+"]");
	...
	public int updateByPrimaryKey(TsysFile record,String dataId) {
		...
		TsysDatas tsysDatas = tsysDatasMapper.selectByPrimaryKey(dataId);
		old_data.setFileName(old_data.getFileName().split("\\[")[0]+"["+tsysDatas.getFilePath()+"]");
